...
export const INITIAL_SUPPLIERS: Supplier[] = [
  ...
  },
  {
    id: "sup-5",
    name: "MAC Cosmetics",
    contact_name: "Deepak Bajracharya",
...
const SUPPLIERS_KEY = "brg_suppliers_data_v2";
