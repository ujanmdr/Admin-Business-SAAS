...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "BRG Admin — Book Relax Glow" },
      { name: "description", content: "Internal admin panel for the BRG team — manage businesses, bookings, payments, and the entire platform." },
    ],
    links: [
